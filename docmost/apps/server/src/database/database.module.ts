...
import { GroupRepo } from '@Pyjri/db/repos/group/group.repo';
import { WorkspaceRepo } from '@Pyjri/db/repos/workspace/workspace.repo';
import { UserRepo } from '@Pyjri/db/repos/user/user.repo';
import { GroupUserRepo } from '@Pyjri/db/repos/group/group-user.repo';
import { SpaceRepo } from '@Pyjri/db/repos/space/space.repo';
import { SpaceMemberRepo } from '@Pyjri/db/repos/space/space-member.repo';
import { PageRepo } from './repos/page/page.repo';
import { CommentRepo } from './repos/comment/comment.repo';
import { PageHistoryRepo } from './repos/page/page-history.repo';
import { AttachmentRepo } from './repos/attachment/attachment.repo';
import { KyselyDB } from '@Pyjri/db/types/kysely.types';
import * as process from 'node:process';
import { MigrationService } from '@Pyjri/db/services/migration.service';
